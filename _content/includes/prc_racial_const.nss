...
//:: Gamma Age Genotypes
const int RACIAL_TYPE_SMLBOT	=	0;
const int RACIAL_TYPE_MEDBOT	=	1;
...
const int RACIAL_TYPE_AMPHID	=	27;
const int RACIAL_TYPE_ARACH		=	30;
const int RACIAL_TYPE_AVIAD		=	31;
const int RACIAL_TYPE_CANIN		=	32;
const int RACIAL_TYPE_EQUIN		=	33;
const int RACIAL_TYPE_FELID		=	34;
const int RACIAL_TYPE_MARSU		=	35;
const int RACIAL_TYPE_MUSTEL	=	36;
const int RACIAL_TYPE_PORCIN	=	37;
const int RACIAL_TYPE_PRIMAX	=	38;
const int RACIAL_TYPE_SECTOID	=	39;
const int RACIAL_TYPE_REPTIOD	=	40;
const int RACIAL_TYPE_RODET		=	41;
const int RACIAL_TYPE_RUMIN		=	42;
const int RACIAL_TYPE_URSIN		=	43;
const int RACIAL_TYPE_SHRUBO	=	44;
const int RACIAL_TYPE_BLOOM		=	45;
const int RACIAL_TYPE_MYCO		=	46;
const int RACIAL_TYPE_CULEN		=	47;
