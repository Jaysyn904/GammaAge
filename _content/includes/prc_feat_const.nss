...
//:: Gamma Age Mutation Feats
const int 	FEAT_MUT_ADAPATATION					=	1200;
const int 	FEAT_MUT_ADHERENCE						=	1201;
const int 	FEAT_MUT_ADRENALINE_BOOST				=	1202;
const int 	FEAT_MUT_ALLUREMENT						=	1203;
const int 	FEAT_MUT_ALTERATION						=	1204;
const int 	FEAT_MUT_ANIMAL_PLANT_CONTROL			=	1205;
const int 	FEAT_MUT_ANTI_LIFE_LEECH				=	1206;
const int 	FEAT_MUT_BEGUILING						=	1207;
const int 	FEAT_MUT_BODY_CONTROL					=	1208;
const int 	FEAT_MUT_CARNIVORUS_JAWS				=	1209;
const int 	FEAT_MUT_CHAMELEON						=	1210;
const int 	FEAT_MUT_CLAWS							=	1211;
const int 	FEAT_MUT_CONFUSION						=	1212;
const int 	FEAT_MUT_CONSTRICTION					=	1213;
const int 	FEAT_MUT_CRYOKINESIS					=	1214;
const int 	FEAT_MUT_DARKVISION						=	1215;
const int 	FEAT_MUT_DEATH_FIELD_GENERATION			=	1216;
const int 	FEAT_MUT_DISPLACEMENT					=	1217;
const int 	FEAT_MUT_DISSOLVING_JUICES				=	1218;
const int 	FEAT_MUT_DISTORTION_FIELD				=	1219;
const int 	FEAT_MUT_DUAL_BRAIN						=	1220;
const int 	FEAT_MUT_DUALITY						=	1221;
const int 	FEAT_MUT_ECHOLOCATION					=	1222;
const int 	FEAT_MUT_EGO_PROJECTION					=	1223;
const int 	FEAT_MUT_ELECTRICAL_GENERATION			=	1224;
const int 	FEAT_MUT_ELECTROMAGNETIC_SENSE			=	1225;
const int 	FEAT_MUT_EMPATHY						=	1226;
const int 	FEAT_MUT_ENERGY_ABSOPTION_ACID			=	1227;
const int 	FEAT_MUT_ENERGY_ABSOPTION_COLD			=	1228;
const int 	FEAT_MUT_ENERGY_ABSOPTION_CONCUSSION	=	1229;
const int 	FEAT_MUT_ENERGY_ABSOPTION_ELECTRICITY	=	1230;
const int 	FEAT_MUT_ENERGY_ABSOPTION_FIRE			=	1231;
const int 	FEAT_MUT_ENERGY_ABSOPTION_RADIATION		=	1232;
const int 	FEAT_MUT_ENERGY_CONVERSION_ACID			=	1233;
const int 	FEAT_MUT_ENERGY_CONVERSION_COLD			=	1234;
const int 	FEAT_MUT_ENERGY_CONVERSION_CONCUSSION	=	1235;
const int 	FEAT_MUT_ENERGY_CONVERSION_ELECTRICITY	=	1236;
const int 	FEAT_MUT_ENERGY_CONVERSION_FIRE			=	1237;
const int 	FEAT_MUT_ENERGY_CONVERSION_RADIATION	=	1238;
const int 	FEAT_MUT_EXOSKELETON					=	1239;
const int 	FEAT_MUT_EXPLOSIVE_SEEDS				=	1240;
const int 	FEAT_MUT_FAST_HEALING					=	1241;
const int 	FEAT_MUT_FEAR_GENERATION				=	1242;
const int 	FEAT_MUT_FIRE_BREATH					=	1243;
const int 	FEAT_MUT_FLEXIBILITY					=	1244;
const int 	FEAT_MUT_FORCE_BARRIER					=	1245;
const int 	FEAT_MUT_FORCE_FIELD_GENERATION			=	1246;
const int 	FEAT_MUT_FRUIT_ANTIBIOTIC				=	1247;
const int 	FEAT_MUT_FRUIT_ANTIDOTE					=	1248;
const int 	FEAT_MUT_FRUIT_ANTI_RAD					=	1249;
const int 	FEAT_MUT_FRUIT_PAINKILLER				=	1250;
const int 	FEAT_MUT_FRUIT_POISON					=	1251;
const int 	FEAT_MUT_FRUIT_STIMULANT				=	1252;
const int 	FEAT_MUT_FRUIT_SUSTENANCE				=	1253;
const int 	FEAT_MUT_GAS_GENERATION_BLINDING		=	1254;
const int 	FEAT_MUT_GAS_GENERATION_CAUSTIC			=	1255;
const int 	FEAT_MUT_GAS_GENERATION_HALLUCINOGENIC	=	1256;
const int 	FEAT_MUT_GAS_GENERATION_PARALYTIC		=	1257;
const int 	FEAT_MUT_GAS_GENERATION_SLEEP			=	1258;
const int 	FEAT_MUT_GAS_GENERATION_WEAKNESS		=	1259;
const int 	FEAT_MUT_GILLS							=	1260;
const int 	FEAT_MUT_HANDS_CAUSTIC					=	1261;
const int 	FEAT_MUT_HANDS_FLAMING					=	1262;
const int 	FEAT_MUT_HANDS_FREEZING					=	1263;
const int 	FEAT_MUT_HANDS_HEALING					=	1264;
const int 	FEAT_MUT_HANDS_SHOCKING					=	1265;
const int 	FEAT_MUT_HEIGHTENED_BALANCE				=	1266;
const int 	FEAT_MUT_HEIGHTENED_HEARING				=	1267;
const int 	FEAT_MUT_HEIGHTENED_PRECISION			=	1268;
const int 	FEAT_MUT_HEIGHTENED_SMELL				=	1269;
const int 	FEAT_MUT_HEIGHTENED_SPEED				=	1270;
const int 	FEAT_MUT_HEIGHTENED_TOUCH				=	1271;
const int 	FEAT_MUT_HEIGHTENED_VISION				=	1272;
const int 	FEAT_MUT_IMMUNITY_ABILITY_DRAIN			=	1273;
const int 	FEAT_MUT_IMMUNITY_ACID					=	1274;
const int 	FEAT_MUT_IMMUNITY_COLD					=	1275;
const int 	FEAT_MUT_IMMUNITY_CONCUSSION			=	1276;
const int 	FEAT_MUT_IMMUNITY_DISEASE				=	1277;
const int 	FEAT_MUT_IMMUNITY_ELECTRICITY			=	1278;
const int 	FEAT_MUT_IMMUNITY_FIRE					=	1279;
const int 	FEAT_MUT_IMMUNITY_MIND					=	1280;
const int 	FEAT_MUT_IMMUNITY_PARALYSIS				=	1281;
const int 	FEAT_MUT_IMMUNITY_POISON				=	1282;
const int 	FEAT_MUT_IMMUNITY_RADIATION				=	1283;
const int 	FEAT_MUT_INTUITION						=	1284;
const int 	FEAT_MUT_INVISIBILITY					=	1285;
const int 	FEAT_MUT_KINETIC_ABSORPTION				=	1286;
const int 	FEAT_MUT_LIFE_FORCE_SENSE				=	1287;
const int 	FEAT_MUT_LIFE_LEECH						=	1288;
const int 	FEAT_MUT_LIFE_TRANSFER					=	1289;
const int 	FEAT_MUT_LOW_LIGHT_VISION				=	1290;
const int 	FEAT_MUT_MENTAL_BLAST					=	1291;
const int 	FEAT_MUT_MENTAL_CONTROL					=	1292;
const int 	FEAT_MUT_MENTAL_PARALYSIS				=	1293;
const int 	FEAT_MUT_METAMORPHOSIS					=	1294;
const int 	FEAT_MUT_MOLECULAR_DISRUPTION			=	1295;
const int 	FEAT_MUT_PARALYTIC_TOUCH				=	1296;
const int 	FEAT_MUT_PARASITE						=	1297;
const int 	FEAT_MUT_PHOTOGENESIS					=	1298;
const int 	FEAT_MUT_PHOTOSYNTHETIC_SKIN			=	1299;
const int 	FEAT_MUT_POISON							=	1300;
const int 	FEAT_MUT_POISONOUS_THORNS				=	1301;
const int 	FEAT_MUT_PROBABILITY_SHIFT				=	1302;
const int 	FEAT_MUT_PYROKINESIS					=	1303;
const int 	FEAT_MUT_QUILLS							=	1304;
...
const int 	FEAT_MUT_SILK_GLANDS					=	1309;
const int 	FEAT_MUT_SIZE_CHANGE_LARGE				=	1310;
const int 	FEAT_MUT_SIZE_CHANGE_SMALL				=	1311;
const int 	FEAT_MUT_SKELETAL_ENHANCEMENT			=	1312;
const int 	FEAT_MUT_SMOKE_CLOUD					=	1313;
const int 	FEAT_MUT_SONIC_BLAST					=	1314;
const int 	FEAT_MUT_SONIC_SCREAM					=	1315;
const int 	FEAT_MUT_SPINES							=	1316;
const int 	FEAT_MUT_STUNNING_FORCE					=	1317;
const int 	FEAT_MUT_TELEKINETIC_HAND				=	1318;
const int 	FEAT_MUT_TELEPORTATION					=	1319;
const int 	FEAT_MUT_TEMPORAL_COMPRESSION			=	1320;
const int 	FEAT_MUT_TEMPORAL_DILATION				=	1321;
const int 	FEAT_MUT_THORNS							=	1322;
const int 	FEAT_MUT_TOTAL_HEALING					=	1323;
const int 	FEAT_MUT_WILL_FORCE						=	1324;
...
const int FEAT_PRACTICED_MIND_BLADE                 = 24413;
